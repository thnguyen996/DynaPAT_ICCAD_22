...
# Count number of pattern:
    ...
    #     total1110 = total11 + total10
    #     total111001 = total11 + total10 + total01
    #     ax.bar(labels, total11, width, edgecolor="black", color="black", label='11')
    #     ax.bar(labels, total10, width, edgecolor="black", color="white", bottom=total11,
    #            label='10')
    #     ax.bar(labels, total01, width, edgecolor="black", color="white", hatch="/", bottom=total1110,
    #            label='01')
    #     ax.bar(labels, total00, width, edgecolor="black", color="white", hatch="+", bottom=total111001,
    #            label='00')
    #     ax.legend(loc=0, prop={"size": 14})
