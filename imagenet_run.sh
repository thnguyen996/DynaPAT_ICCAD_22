...
echo "Running $1 model on imangenet using gpu $3 (stat file $2)"
python compress_classifier.py --arch $1 -p 10 -j 22 /home/imagenet/ --pretrained --run --qe-config-file $2 --gpus $3 --name $1-imagenet-grayencode --method proposed_method --mlc 8 --num_bits 8 --save_data
